...
void clearHalfTransitionCntKeys();

// keyboard input
FSNAPI b8 inputIsKeyDown(keys key);
FSNAPI b8 inputIsKeyUp(keys key);
FSNAPI b8 inputWasKeyDown(keys key);
FSNAPI b8 inputWasKeyUp(keys key);
FSNAPI b8 inputIsKeyReleased(keys key);
FSNAPI b8 inputIsKeyPressed(keys key);

void inputProcessKey(keys key, b8 pressed);

// mouse input
FSNAPI b8 inputIsButtonDown(buttons button);
FSNAPI b8 inputIsButtonPressed(buttons button);
FSNAPI b8 inputIsButtonReleased(buttons button);
FSNAPI b8 inputIsButtonUp(buttons button);
FSNAPI b8 inputWasButtonDown(buttons button);
FSNAPI b8 inputWasButtonUp(buttons button);
FSNAPI void inputGetMousePosition(i32* x, i32* y);
FSNAPI void inputGetPreviousMousePosition(i32* x, i32* y);
