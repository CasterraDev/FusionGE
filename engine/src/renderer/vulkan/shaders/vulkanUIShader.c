...
b8 vulkanUIShaderResourceAcquire(vulkanHeader* header, struct vulkanOverallShader* shader, material* mat) {
    // TODO: free list
...
void vulkanUIShaderResourceRelease(vulkanHeader* header, struct vulkanOverallShader* shader, material* mat) {
    vulkanOverallShaderState* object_state = &shader->objectStates[mat->shaderID];
